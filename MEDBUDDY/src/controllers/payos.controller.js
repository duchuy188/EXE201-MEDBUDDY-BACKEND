...
exports.activateTrialPackage = async(req, res) => {
    try {
        ...
        // Tạo payment record với status PAID (thời gian sẽ được tính trong activateUserPackage)
        ...
        // Kích hoạt gói cho user (sẽ tự động cộng dồn thời gian nếu có gói cũ)
        const user = await activateUserPackage(userId, packageId);
        res.json({
