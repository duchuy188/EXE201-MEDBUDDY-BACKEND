...
exports.createMedicationReminderForPatient = async(req, res) => {
    try {
        ...
        // Nếu reminderType là 'voice' thì chỉ yêu cầu người bệnh có gói active (middleware đã kiểm tra)
        // Không bắt buộc feature riêng lẻ để người thân dễ thao tác theo gói đã mua
...
exports.getPatientAIInsights = async(req, res) => {
    try {
        ...
        // Middleware đã kiểm tra bệnh nhân có gói active, không cần kiểm tra quyền riêng lẻ
